...
import { resendOtpAction, verifyEmailAction } from "@/src/app/(commonLayout)/(authPages)/verify-email/_action";
import { IVerifyEmailProps, verifyEmailZodSchema } from "@/src/zod/auth.validation";
import { useForm } from "@tanstack/react-form";
import { useMutation } from "@tanstack/react-query";
import { ArrowRight, Badge, Loader } from "lucide-react";
  ...
  return (
    <div className="h-full flex items-center">
      <div className="flex flex-col items-start justify-center gap-1 md:w-2xl">
        <Badge fontVariant="outline" className="px-4 py-4">
          UNVERIFIED EMAIL
        </Badge>
